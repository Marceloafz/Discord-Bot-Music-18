...
class MusicPlayer:
    ...
    async def process_next(self):
        ...
        if not self.queue:
            ...
            embed = discord.Embed(
                description=f"A fila está vazia...\nIrei voltar para o inferno em {self.disconnect_timeout/60} minuto(s) caso não seja adicionada novas músicas.",
...
class music(commands.Cog):
    ...
    async def help(self, ctx):
        ...
        embedhelp = discord.Embed(
            ...
            description=helptxt + '\n[Crie seu próprio Bot de Música](https://www.youtube.com/watch?v=PukdzeDliwU)'
        )
